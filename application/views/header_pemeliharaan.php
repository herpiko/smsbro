	...
	<div class="navbar navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container-fluid">
						 <a data-target=".navbar-responsive-collapse" data-toggle="collapse" class="btn btn-navbar"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></a> <a href="#" class="brand">Pemeliharaan<strong>Perangkat</strong></a>
						<div class="nav-collapse collapse navbar-responsive-collapse">
							
              <ul class="nav">
								<li <?php if ($active=='beranda') { echo 'class=active'; } ?>>
									<a href="<?php echo $base_url."beranda"; ?>">Beranda</a>
								</li>
                
                </li>
                <li <?php if ($active=='c_send') { echo 'class=active'; } ?>>
                  <a href="<?php echo $base_url."c_send"; ?>">Tiket Baru</a>
                </li>
                <li <?php if ($active=='c_inbox') { echo 'class=active'; } ?>>
                  <a href="<?php echo $base_url."c_inbox"; ?>">Lihat Tiket</a>
                </li>
                <li <?php if ($active=='c_outbox') { echo 'class=active'; } ?>>
                  <a href="<?php echo $base_url."c_outbox"; ?>">Daftar Perangkat</a>
                </li>
                ...
                <li <?php if ($active=='c_sentitems/failed') { echo 'class=active'; } ?>>
                  <a href="<?php echo $base_url."c_sentitems/failed"; ?>">Gagal Terkirim</a>
								...
								<li class="dropdown">
									 <a data-toggle="dropdown" class="dropdown-toggle" href="#">Pengaturan <strong class="caret"></strong></a>
