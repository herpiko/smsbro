	...
	<div class="navbar navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container-fluid">
						 <a data-target=".navbar-responsive-collapse" data-toggle="collapse" class="btn btn-navbar"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></a> <a href="#" class="brand">Solusi<strong>BKP</strong></a>
              ...
              <ul class="nav">
                ...
                <li <?php if ($active=='c_inbox') { echo 'class=active'; } ?>>
                  <a href="<?php echo $base_url."c_inbox"; ?>">Kotak Masuk</a>
                </li>
                <li <?php if ($active=='c_outbox') { echo 'class=active'; } ?>>
                  <a href="<?php echo $base_url."c_outbox"; ?>">Kotak Keluar</a>
                </li>
